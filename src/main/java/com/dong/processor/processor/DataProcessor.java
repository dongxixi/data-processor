...
import com.dong.processor.annotation.Data;
...
import static com.dong.processor.processor.ProcessUtil.*;


@SupportedAnnotationTypes("com.dong.processor.annotation.Data")
...
//                    JCTree.JCImport anImport = treeMaker.Import(treeMaker.Ident(names.fromString("io.netty.bootstrap.Bootstrap")), false);
//                    jcClass.defs = jcClass.defs.append(anImport);
                    JCTree.JCFieldAccess access = treeMaker.Select(treeMaker.Select(treeMaker.Select(treeMaker.Ident(names.fromString("io")), names.fromString("netty")), names.fromString("bootstrap")), names.fromString("Bootstrap"));
                    JCTree.JCVariableDecl name = treeMaker.VarDef(treeMaker.Modifiers(Flags.PRIVATE), names.fromString("name"), access, null);
                    jcClass.defs = jcClass.defs.append(name);
//                    JCTree.JCVariableDecl abc = treeMaker.VarDef(treeMaker.Modifiers(Flags.PRIVATE), names.fromString("name"),treeMaker.Ident(names.fromString("Bootstrap")), null);
//                    jcClass.defs=jcClass.defs.append(abc);
                    after();
...
//        treeMaker.Select(
//                names.fromString("io"),
//                treeMaker.Select(names.fromString("netty"),
//                        treeMaker.Select(names.fromString("bootstrap"),
//                                names.fromString("Bootstrap"))))
        return true;
    }
